...
void testTsParamOk(CuTest *tc) {
 ...
 // Expect to get the first 4 of these back only, the fifth is just outside the 120 second limit specified by 'ts'
    emptyDb();
    addDbRow(makeTs("2009-11-08 10:00:01"), 1, NULL,  1,  1);
    addDbRow(makeTs("2009-11-08 10:00:00"), 1, NULL,  2,  2);
    addDbRow(makeTs("2009-11-08 09:59:00"), 1, NULL,  4,  4);
    addDbRow(makeTs("2009-11-08 09:58:00"), 1, NULL,  8,  8);
    addDbRow(makeTs("2009-11-08 09:57:59"), 1, NULL, 16, 16);
    ...
    CuAssertStrEquals(tc,
        ...
        "Date: Sun, 08 Nov 2009 10:00:00 +0000" HTTP_EOL
        "Connection: Close" HTTP_EOL HTTP_EOL
        "{serverTime : 1257674400, data : [{dl: 1, ul: 1, ts: -1, dr: 1},{dl: 2, ul: 2, ts: 0, dr: 1},{dl: 4, ul: 4, ts: 60, dr: 1},{dl: 8, ul: 8, ts: 120, dr: 1}]}"
    , result);
}

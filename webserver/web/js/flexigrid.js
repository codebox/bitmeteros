...
(function($){
	...
	$.addFlex = function(t,p)
	{
							 	...
							 	function ()
									{
										...
										td.align = this.align;
										var dataValue = row.cell[idx];
										if (p.formatters[idx]){
											dataValue = p.formatters[idx](dataValue);
										} 
		...
		$('.pReload',g.pDiv).click(function(){p.onReload ? p.onReload() : g.populate()});

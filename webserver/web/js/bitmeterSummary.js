		...
		function populateSummary(){
		 // Take the current Summary values out of the Model and display them
			...
			BITMETER.forEachFilter(function(o){
				...
				var monthVal = getFilterValueFromArray(summary.month, o.id);
				var yearVal  = getFilterValueFromArray(summary.year,  o.id);
				var totalVal = getFilterValueFromArray(summary.total, o.id);
